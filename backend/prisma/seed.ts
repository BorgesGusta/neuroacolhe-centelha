...
async function main() {
  ...
  console.log("🧹 Limpando auditLog...");
  await prisma.auditLog.deleteMany({});
  console.log("🧹 Limpando alert...");
  await prisma.alert.deleteMany({});
  console.log("🧹 Limpando supervisionNote...");
  await prisma.supervisionNote.deleteMany({});
  console.log("🧹 Limpando sessionNote...");
  await prisma.sessionNote.deleteMany({});
  console.log("🧹 Limpando careCase...");
  await prisma.careCase.deleteMany({});
  console.log("🧹 Limpando careQueue...");
  await prisma.careQueue.deleteMany({});
  console.log("🧹 Limpando consentRecord...");
  await prisma.consentRecord.deleteMany({});
  console.log("🧹 Limpando intakeForm...");
  await prisma.intakeForm.deleteMany({});
  console.log("🧹 Limpando accessibilityProfile...");
  await prisma.accessibilityProfile.deleteMany({});
  console.log("🧹 Limpando patient...");
  await prisma.patient.deleteMany({});
  console.log("🧹 Limpando user...");
  await prisma.user.deleteMany({});
  console.log("🧹 Limpando institution...");
