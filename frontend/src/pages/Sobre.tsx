      ...
      <main className="flex-1 flex flex-col justify-start pt-8 items-center px-6 md:px-16 relative z-10 w-full max-w-5xl mx-auto">
        ...
        <div className="w-full text-left">
          <div className="text-justify text-white/90 text-sm md:text-base leading-relaxed space-y-4 max-w-4xl">
            <p>
              O **Nura** é uma solução digital moderna projetada especificamente para gerenciar o fluxo operacional de clínicas-escola, instituições públicas e serviços de psicologia clínica. A plataforma aborda a jornada do acolhimento desde o preenchimento da triagem pública até o encerramento do caso, promovendo a eficiência operacional, segurança de dados em saúde e a inclusão.
            </p>
